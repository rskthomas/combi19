                ...
                <table class="table table-hover">
                    ...
                    <tbody id='rutas'>
                        <tr>
                            ...
                            <!-- BOTON MODIFICAR -->
                            <td>
                                <a href="{{ route('editarruta', ['ruta' => $ruta->id]) }}"  >
                                ...
                                <a href="#ventanaModal" data-toggle="modal">
                                    <button type="button" class="btn btn-primary" title="Eliminar ruta">
                                ...
                                <a href="{{ route('inforuta', ['ruta' => $ruta]) }}">
                                    <button type="button" class="btn btn-primary" title="Ver Ruta">

            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-1  col-md-2">
                        <input type="text" class="form-control-plaintext rounded" id="cantPasajes" name="cantPasajes"
                            value="1">

                    </div>
                    <button type="button" class="btn " title="agregar" id="add"
                        onclick="addPasaje('{{ $viaje->precio }}')">
                    ...
                    <button type="button" class="btn " title="agregar" id="subs"
                        onclick="subsPasaje('{{ $viaje->precio }}')">

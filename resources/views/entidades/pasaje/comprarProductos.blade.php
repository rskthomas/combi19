        ...
        <table class="table table-hover">
            ...
            <tbody id='{{$producto->id}}'>
                <tr>
                    ...
                    <!-- BOTONES -->
                    <td>
                    <button type="button" class="btn " title="agregar" id="addProducto" onclick="agregar('{{$producto->id}}','{{$producto->precio}}','{{$producto->nombre}}','{{$producto->descripcion}}')">
                    ...
                    <button type="button" class="btn " title="sacar" id="subsProducto"  onclick="substraer('{{$producto->id}}','{{$producto->precio}}','{{$producto->nombre}}','{{$producto->descripcion}}')">

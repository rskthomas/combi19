    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0 bg-gray-100">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('viaje.update',['viaje' => $viaje]) }}">
                    ...
                    <x-input id="nombre" class="block mt-1 w-full" type="text" name="nombre" :value="old('nombre',$viaje->nombre)" required autofocus />
...
{{old('descripcion',$viaje->descripcion)}}
                    </textarea>
                    ...
                    <div class='input-group date mt-1' id='datetimepicker1'>
                        <input type='text' placeholder="dd - mm - yyyy" id="fecha_salida" name="fecha_salida" :value="old('fecha_salida',$viaje->fecha_salida)" required readonly class="form-control rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                    ...
                    <div>
                        ...
                        <input type="time" class="block mt-1 w-full" id="hora_salida" name="hora_salida" value="old($viaje->hora_salida)" required>
                    </div>

                    <div class="mt-4 mb-4">
                        <x-label for="precio" :value="__('Precio($ARS)')" />
                        <x-input id="precio" class="block mt-1 w-full" type="number" name="precio" :value="old('precio',$viaje->precio)" :min="0" placeholder="0" required />

                    </div>

                    <div class="mt-4 mb-4">
                        <x-label for="cant_asientos" :value="__('Cantidad de asientos')" />
                        <x-input id="cant_asientos" class="block mt-1 w-full" type="number" name="cant_asientos" :value="old('cant_asientos',$viaje->cant_asientos)" :min="0" placeholder="0" required />
                    ...
                    <script type="text/javascript">
                        ...
                        document.getElementById("fecha_salida").value="<?php echo $viaje["fecha_salida"]; ?>"
                        });

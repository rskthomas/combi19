...
@if(session()->has('pasaje_rechazado'))
    ...
    <div class="alert alert-warning text-center" role="alert">
        <span>El pasajero {{session()->get('pasaje_ausente')->usuario->name}} presenta sintomas de COVID-19 y se marca como rechazado </span>
                    ...
                    <tbody id='viajero'>
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                <a href="{{route('pasaje.cuestionario', ['pasaje'=> $pasaje])}}">
                                    <button type="button" class="btn btn-dark" title="IniciarViaje" disabled>
                                        Iniciar Cuestionario
                                    </button>
                                </a>
                                ...
                                <!-- BOTON VER -->
                                <a class="btn btn-info" role="button"  title="Ver usuario" href="{{ route('user.info', ['user' => $pasaje->usuario]) }}">
